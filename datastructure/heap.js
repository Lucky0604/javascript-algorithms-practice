...
(function(exports) {
    ...
    /**
     * Exchange indexes with start index givens as argument to turn the tree into a valid heap. 
    ...
    /**
     * updates a given node. This operation is useful in algorithms like Dijkstra.
     * A* where we need to decrease/increase value of the given node.
     *
     * @public
