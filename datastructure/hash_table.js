...
(function (exports) {
    ...
    exports.Hashtable.prototype.get = function(key, hashCode) {
        /*
         * make collisions testing easy with optional hashCode parameter.
         * That should not be used, Only by spec/tests
         */
        if (hashCode === undefined) {
            // Typical use
        ...
        if (this.buckets[hashCode] === undefined) {
            ...
            this.buckets[hashCode].next === undefined && this.buckets[hashCode].key === key
        ) {
            return this.buckets[hashCode].data;
        } else {
            var first = this.buckets[hashCode];
            while (
                first !== undefined && first.next !== undefined && first.key !== key
            ) {
                first = first.next;
            }
